...
class GeraImagem:
    ...
    def gerar_imagem(self, nome_arquivo='caca_palavras.png'):
        ...
        img = Image.new('RGBA', (img_width, img_height), color=(0, 0, 0, 0)) # Deixa transparente
        ...
        for line in lines:
            draw.text((margin, y_offset), line, fill='black', font=fonte_palavras)
            y_offset += 30

        # Ajuste da posição inicial da grade com base na quantidade de linhas de palavras
        y0 = y_offset + 20
        x0 = margin
